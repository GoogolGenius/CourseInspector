...
function Course(props) {
    ...
    return (
        <div className='Course'>
            ...
            <p class="coursedescription"><b>Course ID:</b> <code>{course.courseid}</code></p><br></br>
            ...
            {course.corequisite != null && <div><p class="coursedescription"><b>Corequisites:</b> {course.corequisite}</p></div>}
            {course.subsequent != null && <div><p class="coursedescription"><b>Subsequent:</b> {course.subsequent}</p></div>}
            <p class="coursedescription"><b>Considerations:</b> {course.considerations}</p><br></br>
            <p class="coursedescription"><b>Description:</b> {course.description}</p><br></br>
        </div>
    );
}
